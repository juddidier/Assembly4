...
#dj                    if object.TypeId == 'App::Part':
                    if object.TypeId == 'App::Part'  or object.TypeId == 'PartDesign::Body' or object.TypeId == 'Part::FeaturePython':   #dj
...
class infoPartConfUI():
    ...
    def accept(self):
        ...
        partInfoDef = dict()
#dj        for prop in InfoKeys.partInfo:
#dj            partInfoDef.setdefault(prop, {'userData': prop, 'active': True, 'visible': True})
#dj        for prop in InfoKeys.partInfo_Invisible:
#dj            partInfoDef.setdefault(prop, {'userData': prop, 'active': True, 'visible': False})
